...
Both scripts read `LANHU_COOKIE` in this order: `--cookie`, `$LANHU_COOKIE`, `~/.agents/mcp/lanhu-mcp/.env`, `~/.claude/mcp/lanhu-mcp/.env`. Do not read cookie files in the main session.
