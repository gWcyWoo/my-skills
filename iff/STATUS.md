...
Rules: `~/.codex/AGENTS.md`, `SKILL.md`, `test_rules.md`, and the task acceptance criteria.
...
| Scope | Only `~/.agents/skills/iff` was edited; `~/Documents/projects/test` was not touched. | PASS |
