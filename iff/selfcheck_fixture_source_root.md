...
- `/Users/oklik/.agents/skills/iff/scripts/check_fixture_source.py`
- `/Users/oklik/.agents/skills/iff/scripts/selftest_check_fixture_source_root_named_test.py`
...
| Pipeline inventory remains valid | `verify_pipeline_scripts.py --skill-dir /Users/oklik/.agents/skills/iff` reports `ok 71 scripts`. | ✅ |
