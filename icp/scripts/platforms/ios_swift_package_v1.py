...
def describe_package():
    return _core.describe_package(
        platform_id="ios-swift",
        profile_id="ios-swift-standard",
        stem="ios_swift",
        actual_source_type="simulator_screenshot",
        toolchain_shape="shape.xcode_swift_toolchain",
        activation_state="active",
        executable=True,
        binding_basename="ios_swift_execution_binding_v1.py",
        authorization_basename="ios_swift_execution_authorization_v1.py",
        executor_basename="ios_swift_execution_executor_v1.py",
    )
