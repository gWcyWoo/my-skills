...
_TRANSITIVE_SHA256 = {
    ...
    "nextjs_execution_handler_v1.py": "c38a2fd8659cd633ab6f76666311cf81bd8a9db2637c12b14217ace28508442c",
}
...
def describe_package():
    return _core.describe_package(
        ...
        stem="nextjs",
        actual_source_type="browser_screenshot",
        toolchain_shape="shape.node_next_toolchain",
        activation_state="active",
        executable=True,
        binding_basename="nextjs_execution_binding_v1.py",
        authorization_basename="nextjs_execution_authorization_v1.py",
        executor_basename="nextjs_execution_executor_v1.py",
    )
