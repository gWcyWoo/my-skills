...
def describe_package():
    return _core.describe_package(
        platform_id="android-java",
        profile_id="android-java-standard",
        stem="android_java",
        actual_source_type="emulator_screenshot",
        toolchain_shape="shape.android_java_toolchain",
        activation_state="active",
        executable=True,
        binding_basename="android_java_execution_binding_v1.py",
        authorization_basename="android_java_execution_authorization_v1.py",
        executor_basename="android_java_execution_executor_v1.py",
    )
