...
Read the user's requirement (spec, ticket, or message) first. Then invoke the `my-explore` skill to navigate the codebase and find relevant code — pass the requirement context so exploration has a clear search target.
